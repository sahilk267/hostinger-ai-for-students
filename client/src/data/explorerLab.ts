...
export const EXPLORER_PILOT_MISSIONS: ExplorerMission[] = [
  ...
  mission({
    id: "pattern-remix-5-7", pilotKey: "pattern-remix", ageBand: "5-7", kind: "choice-observatory", title: "Remix the Robot Dance", arc: "Patterns", objective: "Notice a repeating pattern and choose what should come next.", skill: "flexibility", scenario: "A toy robot dances clap, turn, clap, turn, then pauses.", task: "Choose the next move and show the repeating pattern with a gesture or drawing.", evidenceFields: ["choice", "reason", "reflection"], rubric: ["Noticed the repeat", "Chose a fitting next move", "Explained or showed the pattern"], feedback: { starter: "You looked for a pattern before choosing.", nextStep: "Invent a new two-step robot dance." }, completionLabel: "Robot pattern saved",
  }),
  mission({
    id: "pattern-remix-8-10", pilotKey: "pattern-remix", ageBand: "8-10", kind: "build-studio", title: "Remix the Sensor Signal", arc: "Patterns", objective: "Use repeated signals to build and test a simple rule.", skill: "planning", scenario: "A robot receives red, red, green, red, red, green signals.", task: "Build a rule for the next signal and describe how you would test it.", evidenceFields: ["artifact", "reason", "revision"], rubric: ["Found a repeat", "Turned it into a rule", "Named a test"], feedback: { starter: "You connected repeated signals to a testable rule.", nextStep: "Try a new signal pattern and compare the rule." }, completionLabel: "Signal pattern saved",
  }),
  mission({
    id: "pattern-remix-11-13", pilotKey: "pattern-remix", ageBand: "11-13", kind: "strategy-switch", title: "Find the Hidden Pattern", arc: "Patterns", objective: "Compare examples, state a rule and revise it when a counterexample appears.", skill: "evidence", scenario: "A sorting bot puts objects in the wrong group whenever colour and shape disagree.", task: "Propose the bot’s current rule, find a counterexample and revise the rule.", evidenceFields: ["artifact", "reason", "revision"], rubric: ["Stated a possible rule", "Used a counterexample", "Made a clearer revision"], feedback: { starter: "You used an exception to improve the rule.", nextStep: "Test the revised rule on two new objects." }, completionLabel: "Pattern rule saved",
  }),
  mission({
    id: "pattern-remix-14-17", pilotKey: "pattern-remix", ageBand: "14-17", kind: "explain-it", title: "Explain an Unfair Pattern", arc: "Patterns", objective: "Explain how a repeated data pattern can hide context and design a check.", skill: "evidence", scenario: "A school dashboard shows one average attendance number, but different groups experience different barriers.", task: "Explain the hidden risk, propose a comparison and name what the dashboard should not claim.", evidenceFields: ["artifact", "reason", "reflection", "revision"], rubric: ["Named missing context", "Proposed a useful comparison", "Set a responsible limit on interpretation"], feedback: { starter: "You looked beyond one convenient average.", nextStep: "Ask whose experience the next measure should make visible." }, completionLabel: "Fair pattern review saved",
  }),
  mission({
    id: "robot-route-5-7", pilotKey: "robot-route", ageBand: "5-7", kind: "choice-observatory", title: "Guide the Friendly Robot", arc: "Systems", objective: "Practice noticing a signal and choosing one safe next step.", skill: "planning", scenario: "A small robot sees a puddle on the path to the toy shelf.", task: "Choose what the robot should notice and do first, then show why with words, pointing or a drawing.", evidenceFields: ["choice", "reason", "reflection"], rubric: ["Noticed the important signal", "Chose a safe action", "Reflected after trying"], feedback: { starter: "You connected what the robot noticed to a helpful action.", nextStep: "Try a different path and see what changes." }, completionLabel: "Robot route saved",
  }),
  mission({
    id: "robot-route-8-10", pilotKey: "robot-route", ageBand: "8-10", kind: "build-studio", title: "Build a Garden Helper", arc: "Systems", objective: "Arrange a simple sensor, rule and action into a useful plan.", skill: "planning", scenario: "A garden robot should help a plant when the soil becomes dry.", task: "Arrange or describe the robot’s signal, rule and action, then explain your choice.", evidenceFields: ["artifact", "reason", "revision"], rubric: ["Connected signal to rule", "Chose a fitting action", "Improved the plan after a clue"], feedback: { starter: "Your plan made the robot’s steps visible.", nextStep: "Test what should happen if the soil is already wet." }, completionLabel: "Garden helper saved",
  }),
  mission({
    id: "robot-route-11-13", pilotKey: "robot-route", ageBand: "11-13", kind: "strategy-switch", title: "Repair the Robot Route", arc: "Systems", objective: "Find a broken step in a rule-based plan and revise it with a test.", skill: "flexibility", scenario: "A delivery robot stops whenever it sees a blue sign, even when the sign means go.", task: "Identify the broken rule, propose a safer replacement and describe one test.", evidenceFields: ["artifact", "reason", "revision"], rubric: ["Located the broken rule", "Proposed a clear revision", "Named a test or stop condition"], feedback: { starter: "You treated the mistake as something to investigate and repair.", nextStep: "Try the revised rule on a second sign." }, completionLabel: "Robot repair saved",
  }),
  mission({
    id: "robot-route-14-17", pilotKey: "robot-route", ageBand: "14-17", kind: "build-studio", title: "Design a Responsible Robot System", arc: "Systems", objective: "Specify a useful automated system with constraints, checks and a human handoff.", skill: "creativity", scenario: "A school wants a robot to help manage a busy equipment room without making sensitive decisions.", task: "Create a system brief with goal, sensor, rule, safety constraint, test and human handoff.", evidenceFields: ["artifact", "reason", "reflection", "revision"], rubric: ["Defined a testable goal", "Included safety and privacy constraints", "Made human responsibility explicit"], feedback: { starter: "Your system design included usefulness and a boundary.", nextStep: "Run the idea past a real user and revise one assumption." }, completionLabel: "Responsible robot system saved",
  }),
];
