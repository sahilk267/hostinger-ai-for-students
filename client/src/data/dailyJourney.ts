...
export const dailyJourney: JourneyDay[] = [
  { day: 1, arc: "FOUNDATIONS", title: "Ask a question that can actually help", outcome: "A clear request for a real task", action: "Rewrite one vague task with a goal, audience and format.", proof: "My request has a goal, context and usable output." },
  ...
  { day: 6, arc: "STUDY SYSTEMS", title: "Turn notes into active recall", outcome: "A five-question practice set", action: "Convert one page of notes into questions before looking at answers.", proof: "I can practice retrieval instead of rereading." },
  ...
  { day: 11, arc: "RESEARCH & EVIDENCE", title: "Break a big question into claims", outcome: "A research question map", action: "Separate the main question into smaller claims that can be checked.", proof: "I know exactly what needs evidence." },
  ...
  { day: 16, arc: "BUILD & CREATE", title: "Turn an idea into a brief", outcome: "A one-page creative brief", action: "Define audience, purpose, message, constraints and success.", proof: "My idea is clear enough for someone else to build." },
  ...
  { day: 21, arc: "CODE & AUTOMATION", title: "Ask for a code explanation", outcome: "A plain-language code map", action: "Explain inputs, outputs, assumptions and failure points in a snippet.", proof: "I understand the code before I change it." },
  ...
  { day: 26, arc: "CAREER & LIFE", title: "Turn experience into evidence", outcome: "An achievement-focused bullet", action: "Use action, task, result and evidence without inventing numbers.", proof: "My experience is specific and believable." },
