          ...
          <section className="explorer-mission-view" aria-labelledby="explorer-mission-heading">
            ...
            <div className="explorer-mission-layout">
              ...
              <div className="explorer-evidence-card">
                <div className="explorer-evidence-head"><div><span className="mission-section-label">STEP 02 / ANSWER</span><h3 id="explorer-answer-heading">{selectedRecord ? "Your evidence is saved." : "Choose and explain your move"}</h3></div>{selectedRecord && <Trophy size={22} />}</div>
                <div className="explorer-answer-controls" aria-labelledby="explorer-answer-heading">
                  <div className="explorer-answer-controls-head"><div><span className="mission-section-label">{copy.playFirst}</span><p>{copy.playFirstHint}</p></div><button type="button" className="explorer-listen" onClick={() => readAloud(`${missionCopy?.scenario ?? mission.scenario}. ${missionCopy?.task ?? mission.task}`)}><Ear size={16} /> {isSpeaking ? copy.listening : copy.listen}</button></div>
