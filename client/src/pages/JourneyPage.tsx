...
const STORAGE_KEY = "aifs-30-day-journey";
type JourneyState = { startedOn: string; completedDays: number[]; lastCompletedOn: string | null };
...
const initialState = (): JourneyState => ({ startedOn: todayKey(), completedDays: [], lastCompletedOn: null });
...
export default function JourneyPage() {
  ...
  const completeDay = () => {
    ...
    const next = { ...state, completedDays: [...state.completedDays, activeDay].sort((a, b) => a - b), lastCompletedOn: today };
    saveState(next); setState(next); toast.success(`Day ${activeDay} milestone earned`);
  };
